...
$(BIN_DIR)/main.out: $(OBJ_DIR)/main.o $(OBJ_DIR)/forager_population.o $(OBJ_DIR)/resource_map.o  $(OBJ_DIR)/forager.o $(OBJ_DIR)/generic/output_functions.o $(OBJ_DIR)/foraging_output_functions.o
	$(CC) -o $@ $^ $(CFLAGS)
